define([
	...
	'use strict';
	module.provider('$datepicker', function () {
		...
		this.$get = ['$window', '$document', '$rootScope', '$sce', 'dateFilter', 'datepickerViews', '$tooltip', 'i18n',
			function ($window, $document, $rootScope, $sce, dateFilter, datepickerViews, $tooltip, i18n) {
